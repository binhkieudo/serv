...
synth_design -top servant -part xc7vx485tffg1761-2
...
write_checkpoint -force -noxdef servant.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file servant_utilization_synth.rpt -pb servant_utilization_synth.pb"
