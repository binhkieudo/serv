...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/serv/build/serv_1.2.1/default-vivado/serv_1.2.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serv_rf_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serv_rf_top.tcl -notrace
