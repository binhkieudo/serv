...
HD_PWD='/home/binhkieudo/Workspace/XRPIX/serv/build/serv_1.2.1/default-vivado/serv_1.2.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serv_rf_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serv_rf_top.tcl
